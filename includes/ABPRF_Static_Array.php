	...
	if (!class_exists('ABPRF_Static_Array')) {
		class ABPRF_Static_Array {
			...
			public static function array_info($key) {
				$des = array(
					'sale_continue' => __('This switch indicate Transport ticket sale close/continue . You can ticket sale close/continue  by this switch. By default sale continue', 'abprf-rental-forge'),
					'display_transport_id' => __('Transport id is unique number which can on/off by this switch.', 'abprf-rental-forge'),
					'display_category' => __('This switch indicate Transport Category . You can on/off by this switch.', 'abprf-rental-forge'),
					'display_organizer' => __('This switch indicate Transport Organizer . You can on/off by this switch.', 'abprf-rental-forge'),
					'abptm_template' => __('Here You can change your details page template.', 'abprf-rental-forge'),
					//=============================//
					'seat_type' => __('Please select your Transport seat type . Default is Seat Plan', 'abprf-rental-forge'),
					'total_seat' => __('Please Type your Transport total Ticket', 'abprf-rental-forge'),
					'display_ticket_type' => __('This switch indicate Transport ticket type. if your all ticket/seat same type then switch will be off. if you want to multiple type please switch on', 'abprf-rental-forge'),
					//=============================//
					'abprf_pricing_warning' => __('This Transport has no route.Please add route from route configuration tab.', 'abprf-rental-forge'),
					//=============================//
					'date_type' => __('Please Select your Transport operational date type. Default operational date will be Periodic', 'abprf-rental-forge'),
					'specific_dates' => __('Please add your Transport operational Specific Date lists', 'abprf-rental-forge'),
					'periodic_start_date' => __('Please add your Transport Launching Date otherwise it will be start today.', 'abprf-rental-forge'),
					'periodic_end_date' => __('Please add your Transport Terminate  Date otherwise it will be Continuously running periodically', 'abprf-rental-forge'),
					'periodic_after' => __('please add your periodically after days. if  your Transport operation day everyday this will be one(1).', 'abprf-rental-forge'),
					'advance_date_number' => __('Kindly provide the number of days in advance for booking. By default, the advance booking period is set to 15 days. ', 'abprf-rental-forge'),
					'weekend' => __('please select your weekend.Default all days open', 'abprf-rental-forge'),
					'specific_off_dates' => __('please add your specific off dates.', 'abprf-rental-forge'),
					'off_date_range' => __('If you have off days between two dates which can add here.', 'abprf-rental-forge'),
					//=============================//
					'display_slider' => __('This switch indicate Transport image slide show. You can on/off by this switch. Please use 2:1 ratio size image and all image same size. ', 'abprf-rental-forge'),
					'abprf_sliders' => __('Please upload Slider images for this Transport', 'abprf-rental-forge'),
					//=============================//
					...
					'additional_services' => __('In order to sell additional products with a ticket, you need to add additional services. Which imports easily from any transport.', 'abprf-rental-forge'),
					'display_single_additional' => __('Here you can set traveller additional form. if you set single additional form for multiple ticket then please switch on other wise additional form will show for each ticket.if you set single additional form then this info add into first ticket. if you set off then additional info set separately each ticket', 'abprf-rental-forge'),
					'abptm_traveller_infos' => __('To obtain information from travelers, please design your form. Which imports easily from any transport.', 'abprf-rental-forge'),
					'abprf_stops' => __('I would appreciate it if you could add any type of stop. The starting point, dropping point, and pickup point are similar.', 'abprf-rental-forge'),
					//=============================//
					'search_get_wrong_data_info' => __('Somethings went Wrong ! Please Try again', 'abprf-rental-forge'),
					'sale_close_msg' => __('This Transport sale close shortly. please try another transport.', 'abprf-rental-forge'),
					'not_found' => __('No Transport Found !', 'abprf-rental-forge'),
					//=============================//
			...
			public static function static_additional(): array {
				return [
					'additional_service_1' => ['icon' => 'fas fa-suitcase-rolling', 'name' => 'Free Luggage', 'qty' => 50, 'max_qty' => 1, 'price' => 0, 'description' => '5 kg · 20×10×10 cm (Maximum one)',],
					'additional_service_2' => ['icon' => 'fas fa-suitcase-rolling', 'name' => 'Additional luggage', 'qty' => 50, 'max_qty' => 2, 'price' => 4.99, 'description' => '20 kg · 80×50×30 cm',],
					'additional_service_3' => ['icon' => 'fas fa-suitcase', 'name' => 'Bulky baggage', 'qty' => 30, 'max_qty' => 3, 'price' => 7.99, 'description' => '50 kg · 80×50×30 cm',],
					'additional_service_4' => ['icon' => 'fas fa-coffee', 'name' => 'Coffee', 'qty' => 100, 'price' => 2.00, 'description' => 'Price for a cup of coffee',]
				];
			}
