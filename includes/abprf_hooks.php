	...
	if ( ! class_exists( 'ABPRF_Hooks' ) ) {
		class ABPRF_Hooks {
			public function __construct() {
				...
				add_action( 'abprf_related_item', [ $this, 'related_item' ], 10, 2 );
			...
			public function related_item( $related_item = '' ): void {
				include_once ABPRF_Function::template_path( 'layout/related_item.php' );
				do_action( 'abprf_related_item_template', $related_item );
			}
