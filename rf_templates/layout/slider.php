<?php
	...
	add_action( 'abprf_slider_template', function ( $abprf_slider = [], $post_id = '' ) {
                ...
                <div class="<?php echo esc_attr( $indication_position ); ?>" data-rf-slider>
                    <div class="slider_show">
						...
						<?php foreach ( $img_infos as $img_info ) { ?>
                            <div class="slider_item" <?php if ( $active_popup == 'on' ){ ?>data-target-popup="<?php echo esc_attr( $popup_id ); ?>"<?php } ?> data-img="<?php echo esc_url( array_key_exists( 'url', $img_info ) ? $img_info['url'] : '' ); ?>">
