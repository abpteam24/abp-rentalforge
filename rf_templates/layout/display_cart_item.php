			...
			<?php if ( ! empty( $ticket_infos ) && sizeof( $ticket_infos ) > 0 ) { ?>
                <div class="_section_xs">
                    ...
                    <ul class="_abprf cart_list">
                        <li><span class="fas fa-calendar-check _mar_r_xs"></span><span class="_fs_label"><?php esc_html_e( 'Rent Start : ', 'abp-rentalforge' ); ?></span>&nbsp;<?php echo esc_html( ABPRF_Function::date_format( $start_time ) ); ?></li>
                        <li><span class="fas fa-calendar-check _mar_r_xs"></span><span class="_fs_label"><?php esc_html_e( 'Rent End : ', 'abp-rentalforge' ); ?></span>&nbsp;<?php echo esc_html( ABPRF_Function::date_format( $end_time ) ); ?></li>
                        <li><span class="fas fa-business-time _mar_r_xs"></span><span class="_fs_label"><?php esc_html_e( 'Duration : ', 'abp-rentalforge' ); ?></span>&nbsp;<?php echo esc_html( $duration ); ?> </li>
						<?php if ( ! empty( $location ) ) { ?>
                            <li><span class="fas fa-location _mar_r_xs"></span><span class="_fs_label"><?php esc_html_e( 'Location : ', 'abp-rentalforge' ); ?></span>&nbsp;<?php echo esc_html( ABPRF_Function::location_value( $location ) ); ?> </li>
						<?php } ?>
                    </ul>
                </div>
                <div class="_section_xs">
					...
					<?php foreach ( $ticket_infos as $ticket_info ) {
                        ...
                        <div class="_divider_xxs"></div>
                        <ul class="_abprf cart_list">
                            <li><span class="_fs_label"><?php esc_html_e( 'Name : ', 'abp-rentalforge' ); ?></span><?php echo esc_html( $ticket_info['name'] ); ?></li>
                            <li><span class="_fs_label"><?php esc_html_e( 'Quantity : ', 'abp-rentalforge' ); ?></span><?php echo esc_html( $ticket_info['qty'] ); ?></li>
                            <li><span class="_fs_label"><?php esc_html_e( 'Rent : ', 'abp-rentalforge' ); ?></span><?php echo wp_kses_post( $price ); ?></li>
                        ...
                        <ul class="_abprf cart_list">
							<?php foreach ( $additional_info as $additional ) {
								if ( is_array( $additional ) && sizeof( $additional ) > 0 ) {
									...
									?>
                                    <li class="_f_wrap">
										<?php ABPRF_Layout::image_icon( $icon_image, '_mar_r_xxs' ); ?><?php echo esc_html( $name . __( ' : ', 'abp-rentalforge' ) ); ?>
                        ...
                        <ul class=" _abprf cart_list">
							<?php foreach ( $attendee_infos as $attendee_info ) {
								...
								if ( ! empty( $label ) && ! empty( $value ) ) { ?>
                                    <li><span class="_fs_label_mar_r_xs"><?php echo esc_html( $label . __( ' : ', 'abp-rentalforge' ) ); ?></span> <?php echo esc_html( $value ); ?></li>
									<?php
								}
							}
							?>
