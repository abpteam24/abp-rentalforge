	...
	if ( ! class_exists( 'ABPRF_Tools' ) ) {
		class ABPRF_Tools {
			public function __construct() {
				...
				//=============================//
				add_action( 'wp_ajax_abprf_create_equipment_list_page', array( $this, 'equipment_list_page' ) );
				add_action( 'wp_ajax_abprf_create_equipment_group_page', array( $this, 'equipment_group_page' ) );
				//=============================//
