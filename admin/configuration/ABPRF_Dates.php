	...
	if (!class_exists('ABPRF_Dates')) {
		class ABPRF_Dates {
			...
			public function tab_content($abprf_infos): void {
				...
				?>
                <div class="tabsItem" data-tabs="#abptm_dates">
                    <h4 class="_abprf_color_theme"><span class="<?php echo esc_attr($transport_icon); ?> _mar_r_xs"></span> <?php echo esc_html($post_title . ' ' . __(' : ', 'abprf-rental-forge') . ' ' . __('Date Configuration', 'abprf-rental-forge')); ?></h4>
			...
			public function select_date_type($date_type): void {
                ...
                <div class="_setting_item">
                    <label class="_f_equal_max_500_f_wrap">
                        <span class="_mar_r_xs"><?php esc_html_e('Operational Date Type', 'abprf-rental-forge'); ?></span>
                        ...
                        <div class="abprf_configuration_content">
								...
								<?php
									if (sizeof($specific_dates)) {
										foreach ($specific_dates as $specific_date) {
											if ($specific_date) {
												$this->specific_date_item('specific_dates[]', $specific_date);
											}
										}
									}
								?>
                            ...
                            <div class="abprf_d_none">
                                <div class="abprf_hidden_item">
									<?php $this->specific_date_item('specific_dates[]'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
			...
			public function specific_date_item($name, $date = ''): void {
				?>
                ...
                <div class="_setting_item">
                    <div class="_f_wrap">
                        ...
                        <div class="abprf_configuration_content">
								...
								<?php
									if (sizeof($specific_off_dates)) {
										foreach ($specific_off_dates as $specific_date) {
											if ($specific_date) {
												$this->specific_date_item('specific_off_dates[]', $specific_date);
											}
										}
									}
								?>
                            ...
                            <div class="abprf_d_none">
                                <div class="abprf_hidden_item">
									<?php $this->specific_date_item('specific_off_dates[]'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="abprf_delete_area ">
                    <div class="_all_center">
                        <div class="_group_content">
							<?php
								ABPRF_LIB_Layout::button_sort();
								ABPRF_LIB_Layout::input_date('abptm_off_from[]', $from_date);
								ABPRF_LIB_Layout::input_date('abptm_off_to[]', $to_date);
								ABPRF_LIB_Layout::button_delete();
							?>
                        </div>
                    </div>
