			...
			public function load_orders( $abprf_info ): void {
                ...
                <div class="abprf_orders _abp_panel">
                    <div class="_panel_head_ov_auto">
                        <h4 class="_abprf"><span class="_mar_r_xxs">📋</span> <?php esc_html_e( 'Order Filter', 'abprf-rental-forge' ); ?></h4>
                    </div>
			...
			public function order_lists( $filter_args = [] ): void {
                ...
                <div class="_panel_head_xs_ov_auto">
                    <div class="_group_content order_status_menu">
                        <button class="_btn_white_xs_text_nowrap <?php echo esc_attr( $data_status == 'all' ? 'rf_active' : '' ); ?>" type="button" data-status="all" title="<?php esc_attr_e( 'All Booking', 'abprf-rental-forge' ); ?>">
							<?php echo esc_html( __( 'All Booking', 'abprf-rental-forge' ) . ' (' . ABPRF_Query::get_booking_query( $filter_args, 0, 0, true ) . ' )' ) ?>
                        </button>
                        <button class="_btn_white_xs_text_nowrap <?php echo esc_attr( ! $data_status ? 'rf_active' : '' ); ?>" type="button" data-status="" title="<?php esc_attr_e( 'Booking Completed', 'abprf-rental-forge' ); ?>">
							<?php
								$filter_args['status'] = '';
