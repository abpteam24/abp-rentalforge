                ...
                <div class="abprf_area  abprf_admin">
                    <div class="admin_head _fj_between">
                        <div class="head_brand _d_flex">
                            <div class="brand_icon _all_center_mar_r_xs"><?php ABPRF_Layout::image_icon( $icon ); ?></div>
                    ...
                    <div class="admin_menu">
                        <div class="menu_list">
                            ...
                            <a href="<?php echo esc_url( ABPRF_Function::build_url( 'posts' ) ); ?>" class="_btn_info post_tab <?php echo esc_attr( $active_tab == 'posts' ? 'rf_active' : '' ); ?>"><?php ABPRF_Layout::image_icon( $icon, '_mar_r_xs' ); ?><?php esc_html_e( 'Post Lists', 'abp-rentalforge' ); ?><sup class="_mar_l_xs_circle_icon_xs"><?php echo esc_html( $total_post ); ?></sup></a>
                    ...
                    <div class="abprf_tabs tab_top">
                        <div class="_panel_head">
                            <div class="tab_lists _group_content">
								...
								<?php if ( ABPRF_Function::on_off( 'location' ) ) { ?>
                                    <a href="<?php echo esc_url( ABPRF_Function::build_url( 'global', [ 'global' => 'location' ] ) ); ?>" class="_btn_light_green_pale_xs  <?php echo esc_attr( $active_tab == 'location' ? 'rf_active' : '' ); ?>"><span class="_mar_r_xxs">📍</span><?php esc_html_e( 'Location', 'abp-rentalforge' ); ?></a>
								<?php } ?>
                                <a href="<?php echo esc_url( ABPRF_Function::build_url( 'global', [ 'global' => 'brand' ] ) ); ?>" class="_btn_light_green_pale_xs  <?php echo esc_attr( $active_tab == 'brand' ? 'rf_active' : '' ); ?>"><span class="_mar_r_xxs">🏷️</span><?php esc_html_e( 'Brand', 'abp-rentalforge' ); ?></a>
